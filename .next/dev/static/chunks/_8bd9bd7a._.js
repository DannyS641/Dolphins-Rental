...
"[project]/lib/admin.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function initAdminPage() {
    ...
    if (!sb) {
        showMsg("bookingMsg", "Supabase is not configured. Add your keys in .env.local.", "bad");
        adminCleanup = ()=>{
    ...
    const init = async ()=>{
        ...
        const { data: authData } = sb.auth.onAuthStateChange((_event, session)=>{
...
async function loadCourts() {
    const { data, error } = await sb.from("courts").select("id,name,slug,hourly_rate,daily_rate,weekly_rate,is_active").order("name", {
        ascending: true
    });
    if (error) {
        console.error(error);
...
async function loadBookings() {
    ...
    const { data, error } = await sb.from("bookings").select("id,created_at,status,plan,start_date,end_date,start_time,total_amount,customer_name,customer_phone,customer_email,court_id,courts(name)").order("created_at", {
        ascending: false
    });
    if (error) {
        console.error(error);
...
async function loadBlocks() {
    const { data, error } = await sb.from("availability_blocks").select("id,start_date,end_date,court_id,courts(name)").order("start_date", {
        ascending: false
    });
    if (error) {
        console.error(error);
...
async function loadPromos() {
    const { data, error } = await sb.from("promo_codes").select("id,code,type,value,is_active,redeemed_count,max_redemptions,min_amount").order("code", {
        ascending: true
    });
    if (error) {
        console.error(error);
...
function renderBookings() {
    ...
    body.innerHTML = rows.map((b)=>{
        ...
        const dates = b.plan === "Hourly" ? `${b.start_date} ${b.start_time}` : `${b.start_date} to ${b.end_date}`;
        return `
        <tr>
          <td>
          ...
          <td><span class="pill ${escapeHtml(b.status)}">${escapeHtml(b.status)}</span></td>
          <td>
            <div class="admin-actions">
              <button class="btn btn--light" data-action="confirmed" data-id="${b.id}">Confirm</button>
              <button class="btn btn--light" data-action="rejected" data-id="${b.id}">Reject</button>
            </div>
          </td>
        </tr>
      `;
...
function renderBlocks() {
    ...
    if (!body) return;
    body.innerHTML = state.blocks.map((b)=>{
        return `
      <tr>
...
function renderPromos() {
    ...
    body.innerHTML = state.promos.map((p)=>{
        const usage = p.max_redemptions == null ? `${p.redeemed_count || 0} / unlimited` : `${p.redeemed_count || 0} / ${p.max_redemptions}`;
        return `
      <tr>
...
function renderCourts() {
    ...
    if (!body) return;
    body.innerHTML = state.courts.map((c)=>{
        return `
      <tr>
...
function renderCourtSelects() {
    ...
    if (!select) return;
    select.innerHTML = state.courts.map((c)=>`<option value="${c.id}">${escapeHtml(c.name)}</option>`).join("");
}
async function updateBookingStatus(id, status) {
    ...
    if (!updated) {
        showMsg("bookingMsg", "No rows updated. Check RLS update policy for bookings.", "bad");
        return;
    }
    state.bookings = state.bookings.map((b)=>b.id === updated.id ? {
            ...b,
...
"[project]/components/AdminClient.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/admin.js [app-client] (ecmascript)");
;
...
function AdminClient() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminClient.useEffect": ()=>{
            const cleanup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initAdminPage"])();
            return ({
                "AdminClient.useEffect": ()=>{
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "container admin-header__inner",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                    ...
                                    fileName: "[project]/components/AdminClient.jsx",
                                    lineNumber: 20,
                                    columnNumber: 13
                                }, this),
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                className: "container admin-main",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        className: "admin-auth",
                        id: "adminAuth",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "admin-panel admin-auth__panel",
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "admin-muted",
                                    children: "Sign in to manage bookings, blocks, and promo codes."
                                }, void 0, false, {
                                    fileName: "[project]/components/AdminClient.jsx",
                                    lineNumber: 45,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                    className: "admin-form admin-auth__form",
                                    id: "loginForm",
                                    children: [
...
_s(AdminClient, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = AdminClient;
var _c;
...
//# sourceMappingURL=_8bd9bd7a._.js.map